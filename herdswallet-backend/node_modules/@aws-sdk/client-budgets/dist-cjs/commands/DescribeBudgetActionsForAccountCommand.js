...
class DescribeBudgetActionsForAccountCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, DescribeBudgetActionsForAccountCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_json1_1_1.serializeAws_json1_1DescribeBudgetActionsForAccountCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_json1_1_1.deserializeAws_json1_1DescribeBudgetActionsForAccountCommand)(output, context);
    }
}
